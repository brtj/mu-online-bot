...
from functions.host_api import press_leter_i, press_leter_p, send_message, activate_window
...
def check_if_its_in_party(player_info=None):
    ...
    party_status = post(HOSTAPI_ENDPOINTS["find_and_hover"], payload);time.sleep(0.2)
