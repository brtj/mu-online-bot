...
WARP_MESS = [
    "Dobra zwijam sie do {desired_location}",
    "Lece juz do {desired_location}",
    "Zbieram manatki, kierunek {desired_location}",
    "Zmieniam mape na {desired_location}",
    "Przenosze sie do {desired_location}",
    "Czas na {desired_location}, nara",
    "Ide ogarnac {desired_location}",
    "Kieruje sie do {desired_location}",
    "Skacze teraz na {desired_location}",
    "Teleport na {desired_location}",
    "Spotykamy sie w {desired_location}",
    "Uciekam na {desired_location}",
    "Czas sprawdzic {desired_location}",
    "Znikam stad, lece {desired_location}",
    "Przeprowadzka do {desired_location}",
    "Szybki wypad do {desired_location}",
    "Wracam na {desired_location}",
    "Pora odwiedzic {desired_location}",
    "Przerzucam sie na {desired_location}",
    "Ide farmic w {desired_location}",
    "Laduje zaraz w {desired_location}",
    "Zaraz bede w {desired_location}",
    "Zmiana spotu na {desired_location}",
    "Przelatuje na {desired_location}",
    "Przenosiny do {desired_location}",
    "Lecimy na {desired_location}",
    "Wbijam na {desired_location}",
    "Wpadam do {desired_location}",
    "Czas ruszyc do {desired_location}",
